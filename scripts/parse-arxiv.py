...
def save_current(list_of_nodes_to_add, list_of_edges_to_add, id_of_searched):
    appended_nodes = open('data_set_with_arxiv/Nodes','a')
    appended_edges = open('data_set_with_arxiv/Edges','a')
    ...
    position_saver = open('scripts/save_position_arxiv', 'w+')
...
if __name__ == "__main__":
    ...
    nodes = open('data_set_with_arxiv/Nodes','r+')
    nodes_by_lines = nodes.readlines()
    
    # gets the current edges
    edges = open('data_set_with_arxiv/Edges','r+')
    ...
    position_saver = open('scripts/save_position_arxiv', 'r+')
    position_saver.seek(0)
